...
const { normalizeClaudeCode, normalizeCodex, normalizeOpenCode } = require('../src/bridge/core/normalizer');
const { assertNoSyntheticEvidence } = require('../src/bridge/core/turn-identity');
