...
const { ensureRuntimeHome } = require('../src/bridge/core/runtime-home');
const { Journal } = require('../src/bridge/core/journal');
const { repoIdentityKey } = require('../src/bridge/core/repo-context');
const hookEntry = require('../src/bridge/connectors/opencode/hook-entry');
const {
  installOpenCodePlugin,
  statusOpenCodePlugin,
  uninstallOpenCodePlugin,
  PLUGIN_FILE_NAME
} = require('../src/bridge/installers/opencode/installer');
