...
const { buildRepoIdentityV1, resolveRepoContext } = require('../src/core/repo-context');
const { addProject } = require('../src/core/project-registry');
const { journalFor, globalJournalDir, projectJournalDir } = require('../src/core/journal-router');
